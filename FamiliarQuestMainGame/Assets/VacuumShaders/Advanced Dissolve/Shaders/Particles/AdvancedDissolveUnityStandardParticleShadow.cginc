    ...
    out float4 opos : SV_POSITION)
{
    ...
    CURVED_WORLD_TRANSFORM_POINT(opos)
    ...
    TRANSFER_SHADOW_CASTER_NOPOS(o,opos)
                ...
                o.texcoord2AndBlend.z = v.texcoords1.x;
            #endif
        #else
    ...
    ADVANCED_DISSOLVE_INIT_DATA(UnityObjectToClipPos(v.vertex), v.texcoords, v.texcoords1, o)
#endif

#ifdef UNITY_STANDARD_USE_STEREO_SHADOW_OUTPUT_STRUCT
	os.worldPos = mul(unity_ObjectToWorld, float4(v.vertex.xyz, 1)).xyz;
    o.normalWS = UnityObjectToWorldNormal(v.normal);
    ADVANCED_DISSOLVE_INIT_DATA(UnityObjectToClipPos(v.vertex), v.texcoords, v.texcoords1, o)
#endif
}
...
#ifdef UNITY_STANDARD_USE_SHADOW_OUTPUT_STRUCT
    float4 dissolveAlpha = AdvancedDissolveGetAlpha(i.texcoord.xy, i.worldPos, i.normalWS, i.dissolveUV);		
	DoDissolveClip(dissolveAlpha);
#endif
