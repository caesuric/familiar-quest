...
Shader "VacuumShaders/Advanced Dissolve/Particles/Anim Alpha Blended" {
Properties {
...
#include "../cginc/Integration_CurvedWorld.cginc"
            ...
            v2f vert (appdata_t v)
            {
                ...
                ADVANCED_DISSOLVE_INIT_DATA(o.vertex, v.texcoords, v.texcoordBlend, o)
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				float4 blend = lerp(colA, colB, i.blend);

				//Albedo
				blend.rgb = lerp(blend.rgb, dissolveAlbedo, dissolveBlend);


                fixed4 col = 2.0f * i.color * blend;
