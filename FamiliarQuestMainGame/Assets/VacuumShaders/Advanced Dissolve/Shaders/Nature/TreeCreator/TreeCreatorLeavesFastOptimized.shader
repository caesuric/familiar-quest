Shader "VacuumShaders/Advanced Dissolve/Nature/Tree Creator/Leaves Fast Optimized" {
Properties {
...
#include "../../cginc/Integration_CurvedWorld.cginc"
		...
		float4 dAlpha = AdvancedDissolveGetAlpha(IN.hip_pack0.xy, IN.worldPos, IN.normalWS, IN.dissolveUV);
		DoDissolveClip(dAlpha);
...
Dependency "BillboardShader" = "VacuumShaders/Advanced Dissolve/Nature/Tree Creator/Leaves Rendertex"
