Shader "VacuumShaders/Advanced Dissolve/Nature/Tree Creator/Bark" 
{
Properties {
...
SubShader {
    Tags { "IgnoreProjector"="True" "RenderType"="AdvancedDissolveTreeBark" }
	Cull[_Cull]
    LOD 200
...
fixed4 frag_surf (v2f_surf IN) : SV_Target {
  ...
  float4 alpha = AdvancedDissolveGetAlpha(IN.uv.xy, IN.worldPos, IN.normalWS, IN.dissolveUV);
DoDissolveClip(alpha);
...
Dependency "OptimizedShader" = "VacuumShaders/Advanced Dissolve/Nature/Tree Creato/Bark Optimized"
