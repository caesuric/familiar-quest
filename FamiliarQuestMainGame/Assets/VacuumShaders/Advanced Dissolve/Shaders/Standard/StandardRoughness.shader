Shader "VacuumShaders/Advanced Dissolve/Standard/Roughness"
{
    Properties
    {
...
[HideInInspector][Enum(World,0,Local,1)]                                            _DissolveMaskSpace("Space", Float) = 0	 
    ...
    SubShader
    {
        Tags { "RenderType"="AdvancedDissolveCutout" "PerformanceChecks"="False" }
        LOD 300
		Cull[_Cull]
        ...
        Pass
        {
			...
			//#pragma shader_feature ___ _DETAIL_MULX2	//Not supported in SM3.0
...
#define DISSOLVE_LEGACY_TEXTURE_SAMPLE
    ...
    CustomEditor "VacuumShaders.AdvancedDissolve.StandardRoughnessShaderGUI"
}
